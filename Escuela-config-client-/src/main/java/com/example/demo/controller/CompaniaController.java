...
public class CompaniaController {
	...
	public CompaniaDTO actualizarCompani(@PathVariable("idCompania") Long idCompania, @RequestBody CompaniaDTO companiaDto){
		//companiaService.actualizarCompania( idCompania,companiaDto);
		return null;
	}
